...
if [ "${CASROOT}" == "" ]; then
  export CASROOT="/home/galbramc/util/ESP/opencascade-7.4/trunk/build_release/OpenCASCADE-7.4.1"
fi

# ----- Define path to 3rdparty products -----
export THIRDPARTY_DIR="/home/galbramc/util/ESP/opencascade-7.4/trunk"
