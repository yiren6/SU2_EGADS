                               ...
                               int withMotion)
{
    ...
    if (aimInputs[Design_Sensitivity-1].vals.integer == (int)true) {
        snprintf(filename, PATH_MAX,"%s_adjoint%s", aimInputs[Proj_Name-1].vals.string, fileExt);
    } else {
        snprintf(filename, PATH_MAX,"%s%s", aimInputs[Proj_Name-1].vals.string, fileExt);
    }
    ...
    if (aimInputs[Design_Sensitivity-1].vals.integer == (int)true) {
        fprintf(fp,"MATH_PROBLEM = DISCRETE_ADJOINT\n");
    } else {
    ...
    if (aimInputs[Design_Sensitivity-1].vals.integer == (int)true) {
      fprintf(fp,"OBJECTIVE_FUNCTION=");
      for (i = 0; i < design.numDesignFunctional; i++) {
        fprintf(fp, " %s", design.designFunctional[i].component->name);
        if (i < design.numDesignFunctional-1) fprintf(fp, ",");
        else                                  fprintf(fp, "\n");
      }
    } else {
    ...
    if (aimInputs[Design_Sensitivity-1].vals.integer == (int)true) {
        fprintf(fp,"SOLUTION_FILENAME= restart_flow_%s.dat\n", aimInputs[Proj_Name-1].vals.string);
    } else {
    ...
    if (aimInputs[Design_Sensitivity-1].vals.integer == (int)true) {
        fprintf(fp, "RESTART_ADJ_FILENAME= restart_adj_%s.dat \n", aimInputs[Proj_Name-1].vals.string);
    } else {
    ...
    if (aimInputs[Design_Sensitivity-1].vals.integer == (int)true) {
        fprintf(fp,"VOLUME_ADJ_FILENAME= adjoint_%s \n", aimInputs[Proj_Name-1].vals.string);
    } else {
