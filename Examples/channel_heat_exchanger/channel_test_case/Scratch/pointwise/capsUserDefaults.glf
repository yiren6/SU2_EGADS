...
set domParams(MaxEdge)                         0.105000; # Domain maximum edge length
...
set blkParams(maxLayers)                        30; # Maximum layers
set blkParams(growthRate)                      1.200000; # Growth rate for volume T-Rex extrusion
